import getCurrentTrack from "./get-current-track";
...
describe("getCurrentTrack", function() {
  ...
  it("should resolve the data from spotify", function(done) {
    return getCurrentTrack("authToken", spotifyDatasource).then(result => {
...
const spotifyApiResult = {
  ...
  shuffle_state: false,
  repeat_state: "off",
  timestamp: 1566303018380,
  context: {
    external_urls: {
      spotify: "https://open.spotify.com/playlist/2DAEN1ySxyaHaRJewW24oF"
    },
    href: "https://api.spotify.com/v1/playlists/2DAEN1ySxyaHaRJewW24oF",
    type: "playlist",
    uri: "spotify:playlist:2DAEN1ySxyaHaRJewW24oF"
  },
  progress_ms: 185611,
  item: {
    album: {
